...
def _load_config_with_base(file_path):
    # Configuration files and dataset paths may contain non-ASCII text.  The
    # Windows locale is not guaranteed to be UTF-8, so relying on the process
    # default encoding makes otherwise valid YAML fail to load.
