...
def get_denoising_training_group(targets,
    ...
    if label_noise_ratio > 0:
        ...
        # Paddle 3.x no longer promotes bool * float32. This is a mask
        # intersection, so keep the operation explicitly boolean.
        chosen_idx = paddle.nonzero(
            paddle.logical_and(mask, pad_gt_mask.astype('bool'))).squeeze(-1)
